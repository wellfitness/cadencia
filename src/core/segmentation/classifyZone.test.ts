...
describe('classifyZone con FTP (Coggan estricto)', () => {
  // FTP=200, asi que: Z1<110, Z2 110-150, Z3 150-180, Z4 180-210, Z5 >=210
  it('100 W (50% FTP) -> Z1', () => {
  ...
  it('250 W (125% FTP, antes Z6) -> Z5', () => {
    expect(classifyZone(250, withFtp)).toBe(5);
  });

  it('frontera exacta 90% FTP (180 W) -> Z3 (limite estricto <90%)', () => {
    // ratio < 0.9 -> Z3, ratio >= 0.9 -> Z4. 180/200 = 0.9 -> Z4
...
describe('classifyZone sin FTP (fallback 2.5 W/kg estimado)', () => {
  ...
  // Z1<96.25, Z2<131.25, Z3<157.5, Z4<183.75, Z5>=183.75
